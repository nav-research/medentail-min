...
### Authors- Melike Nur Yegin, Gulsum Yigit, Fatma Gumus

A minimal, dependency-light implementation of MedEntail — a worst-case, entailment-based faithfulness metric for medical text simplification. See the [docs](./docs/index.md) for the design rationale; this README covers installation and usage. Pages at: https://nav-research.github.io/medentail-min/ 
